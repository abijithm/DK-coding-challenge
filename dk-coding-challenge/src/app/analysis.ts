...
//     var res11 = searchContinuityAboveValue(ax, 880, 920, 25.0, 3);
//     console.log(res11);
//     console.log('\n')
//     var res12 = searchContinuityAboveValue(wz, 800, 1000, 10.0, 7);
//     console.log(res12);

//     console.log("\n ********** Operation 2 ********** \n")

//     var res21 = backSearchContinuityWithinRange(ax, 880, 920, 10.0, 17.0, 3);
//     console.log(res21);
//     console.log('\n')
//     var res22 = backSearchContinuityWithinRange(ay, 245, 300, 0.00, 0.3, 13);
//     console.log(res22);
    
//     console.log("\n ********** Operation 3 ********** \n")

//     var res31 = searchContinuityAboveValueTwoSignals(ax, ay, 870, 920, 0.0, -15.0, 3);
//     console.log(res31);
//     console.log('\n')
//     var res32 = searchContinuityAboveValueTwoSignals(az, wx, 400, 600, 0.0, 0.2, 4);
//     console.log(res32);
    
//     console.log("\n ********** Operation 4 ********** \n")

//     var res41 = searchMultiContinuityWithinRange(ax, 880, 920, 10.0, 17.0, 3);
//     console.log(res41)
//     console.log('\n')
//     var res42 = searchMultiContinuityWithinRange(ax, 880, 920, 0.0, 17.0, 3);
//     console.log(res42)
